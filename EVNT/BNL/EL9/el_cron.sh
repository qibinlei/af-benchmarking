...
readonly CONDOR_LOG_DIR="/usatlas/u/qlei/batch_output_files/evnt/el"
...
submit_out=$(bash "${AF_BENCH_DIR}/EVNT/BNL/EL9/submit.sh")
echo "${submit_out}"
...
condor_log="${CONDOR_LOG_DIR}/evnt_EL9.${cluster_id}.0.log"
